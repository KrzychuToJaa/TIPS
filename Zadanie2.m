...
% ETAP 1: Wygenerowanie alfabetu 0..9 oraz a..z
alfabet = ['0':'9', 'a':'z'];
rozmiar_alfabetu = length(alfabet);
symbole_alfabetu = num2cell(alfabet);

% ETAP 2: Zakodowanie dowolnego (losowego) ciągu o długości >= 1000 znaków
dlugosc_ciagu = 1000;
...
% ETAP 3: Zakodowanie tekstu o długości >= 1000 znaków
...
if  (czy_identyczne_tekst) % <- Tutaj poprawiłem z czy_identyczne_losowe na _tekst
    disp('Ciąg znaków zgodny z oryginałem');
end
